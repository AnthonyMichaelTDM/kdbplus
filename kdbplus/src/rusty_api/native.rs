...
extern "C" {
    ...
    ///
    /// #[no_mangle]
    /// pub extern "C" fn create_timespan(_: *const K) -> *const K{
    ...
    /// -1D01:30:00.001234567
    /// ```
    pub fn ktj(qtype: I, nanoseconds: J) -> *const K;
    ...
    /// -01:30:00.123
    /// ```
    pub fn kt(milliseconds: I) -> *const K;

    /// Constructor of q compound list.
    /// # Example
    /// See the example of [`xD`](fn.xD.html).
    pub fn knk(qtype: I, ...) -> *const K;

    /// Constructor of q simple list.
    /// # Example
    /// See the example of [`xD`](fn.xD.html).
    pub fn ktn(qtype: I, length: J) -> *const K;
    ...
    /// ```
    pub fn kpn(chararray: S, length: J) -> *const K;
    ...
    /// ```
    pub fn xT(dictionary: *const K) -> *const K;
    ...
    /// 2008.08.12D23:12:24.018691392 30.5    
    /// ```
    pub fn ktd(keyedtable: *const K) -> *const K;
    ...
    /// 2008.08.12D23:12:24.018691392| 30.5  
    /// ```
    pub fn knt(keynum: J, table: *const K) -> *const K;
    ...
    pub fn ja(list: *mut K, value: *mut V) -> *const K;
    ...
    /// `a`b`c`d`e
    /// ```
    pub fn jv(list1: *mut K, list2: *const K) -> *const K;
    ...
    pub fn jk(list: *mut K, value: *const K) -> *const K;
    ...
    pub fn js(list: *mut K, symbol: S) -> *const K;
    ...
    /// error: type
    /// ```
    pub fn ee(result: *const K) -> *const K;
    ...
    /// 20 200
    /// ```
    pub fn k(socket: I, query: const_S, ...) -> *const K;
    ...
    /// "Look! HE has come!!"
    /// ```
    pub fn b9(mode: I, qobject: *const K) -> *const K;
    ...
    ///
    pub fn d9(bytes: *const K) -> *const K;
    ...
    /// extern "C" fn counter(socket: I) -> *const K{
    ...
    ///
    /// #[no_mangle]
    /// pub extern "C" fn enable_counter(socket: *const K) -> *const K{
    ///   unsafe{
    ...
    /// `Counter_punch!!
    /// ```
    pub fn sd1(socket: I, function: extern "C" fn(I) -> *const K) -> *const K;
    ...
    /// `son_of_man
    /// ```
    pub fn r1(qobject: *const K) -> *const K;
    ...
    /// `text
    /// ```
    pub fn dot(func: *const K, args: *const K) -> *const K;
    ...
    pub fn dl(func: *const V, n: J) -> *const K;
    ...
    pub fn sslInfo(_: *const K) -> *const K;
    ...
    fn vaknk(qtype: I, args: va_list) -> *const K;

    /// Variadic version of `k`.
    fn vak(qtype: I, query: const_S, args: va_list) -> *const K;
